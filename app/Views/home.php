...
<!--  -->
  <div class="container mt-3 mt-lg-5">
    <div class="row">
      ...
      <ul class="nav nav-tabs gap-2 gap-lg-3" id="myTab" role="tablist">
...
$placeholder_data = [
    [
        ...
        "thumb" => "https://via.placeholder.com/680x380.png/0055cc?text=animals+sequi",
    ...
    <div class="card-container mt-5">
        <a href="<?= base_url('/ecourse/' . $value['course_id'] . '/'); ?>" class="text-decoration-none d-flex flex-column gap-2 h-100">
            ...
            <div class="d-flex justify-content-between align-items-center mt-2">
                <div class="ctg-label">Kategori</div>
            ...
            <div class="card-footer d-flex justify-content-between align-items-center">
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <p class="my-auto"><?= $value['mentor']; ?></p>
                </div>
            </div>
        </a>
    </div>
...
?>
    ...
    <button class="d-flex justify-content-between btn-selengkapnya mt-4 mx-auto gap-3">
      <a href="#home" class="">Lihat Selengkapnya</a>
...
<section class="d-flex flex-column container px-0 mt-5 align-items-center gap-4">
  ...
  <div class="accordion w-100 d-flex flex-column gap-2 accordion-flush" id="accordionFlushExample">
    <div class="accordion-item">
      <h2 class="accordion-header ">
        ...
        <img src="images/bell.svg" alt="">Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestias, cum.
        </button>
      </h2>
    ...
    <div class="accordion-item">
      <h2 class="accordion-header">
        ...
        <img src="images/cart.svg" alt="">Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestias, cum.
        </button>
      </h2>
