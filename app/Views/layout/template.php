  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg sticky-top bg-white" data-bs-theme="light">
        <div class="container">
            ...
            <div class="icon-wrapper d-flex gap-2">
                ...
                ?>" alt="">
                <button type="button" class="btn btn-dark rounded-5 px-3">Masuk</button>
            </div>
    ...
    <footer
        ...
        <section class="">
            ...
            <div class="row">
            <!-- Grid column -->
            <div class="col-md-3 col-lg-3 col-xl-4 mx-auto mt-3 mb-4">
                <div>
            ...
            <div class="col-md-2 col-lg-2 col-xl-3 mx-auto mt-3">
                <h6 class=" mb-4 font-weight-bold">Alamat</h6>
                <p>
